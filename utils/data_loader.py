...
# pre-process tensor
def tensor_loader(tensor, mask = False, rgb_to_grayscale = False):
    """
    ...
    Arguments:
        ...
        rgb_to_grayscale: whether rgb tensor is firstly transformed into grayscale and then is duplicated over channels, boolean
    Returns:
    ...
    if not mask:
        ...
        if rgb_to_grayscale:
            tensor = transforms.functional.rgb_to_grayscale(tensor.permute(2,0,1)).repeat(3,1,1)
        else:
